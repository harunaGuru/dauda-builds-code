...
const Experience = () => {
  ...
  const skills = [
    ...
    { category: "Styling", items: ["Tailwind CSS", "Styled Components", "SASS", "Bootstrap"] },
    { category: "Backend", items: ["Node.js", "Express", "REST APIs", "GraphQL"] },
    { category: "Tools", items: ["Git", "Webpack", "Vite", "Jest", "React Testing Library"] },
    { category: "Animation", items: ["GSAP", "Framer Motion", "CSS Animations"] },
